...
#Usuarios
User.create!(name:"Arthur", email:"arthur@arthur" ,is_admin:true, password:"arthur1234")
User.create!(name:"Gabriel", email:"gabriel@gabriel" ,is_admin:false, password:"gabriel1234")
User.create!(name:"David", email:"david@david" ,is_admin:false, password:"david1234")
User.create!(name:"Lucas", email:"lucas@lucas" ,is_admin:false, password:"lucas1234")
User.create!(name:"Nicolas", email:"nicolas@nicolas" ,is_admin:false, password:"nicolas1234")
